...
const FIELD_RELATED_KEYS: Record<string, string[]> = {
  ...
  faculdade_tem_doutorado: ["faculdade_tem_doutorado", "faculdade_tem_mestrado", "faculdade_programas_capes"],
  faculdade_tem_mestrado: ["faculdade_tem_doutorado", "faculdade_tem_mestrado"],
  faculdade_programas_capes: ["faculdade_programas_capes"],
...
const FIELD_LABELS: Record<string, string> = {
  ...
  apresentacoes: "Trabalhos em congressos",
  ...
  faculdade_tem_doutorado: "Doutorado na faculdade",
  faculdade_tem_mestrado: "Mestrado na faculdade",
  faculdade_programas_capes: "Programas CAPES",
  comissao_avaliacao_semestres: "Comissão de avaliação/reforma",
